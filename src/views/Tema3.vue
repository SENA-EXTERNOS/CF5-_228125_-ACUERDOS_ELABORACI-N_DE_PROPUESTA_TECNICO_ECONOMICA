...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Acuerdos de confidencialidad
  
    p.mb-0 Cuando se realizan contratos o acuerdos, es extremadamente importante el tema de confidencialidad. En el siguiente video podrá conocer qué es un acuerdo de confidencialidad y las consecuencias que genera su incumplimiento.
    br

    figure
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/QljZLNtJuoE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5(data-aos="fade-left")
    ...
    .row.justify-content-around.align-items-center
      ...
      .col-8
        ...
        p.p-4 La propiedad intelectual en la industria del #[i software], usualmente abarca, en sus contratos, la forma de proceder bajo la ley en caso de eventualidades inesperadas o de incumplimientos en el contrato o proyectos ejecutados en cualquier modalidad; es decir, cuando exista actividad irregular en los procesos establecidos, la normativa actúa de forma automática sobre las inestabilidades y las incurrencias y, a su vez, pena al ente que infringe lo estipulado.
      .col-4
    ...
    .row.justify-content-around.align-items-center
      ...
      .col-7
        .bloque-texto3-acuerdos-confidencialidad
          .bloque2-texto3-acuerdos-confidencialidad.p-3 Existe una legislación y una reglamentación, basada en las modificaciones realizadas en el proyecto, que pueden ocurrir bien por cambios inesperados, por mejoras en tecnologías, o por requerimientos. Estos casos deben quedar planteados en la documentación y en los acuerdos, para evitar incurrir más adelante en penalidades. Sin embargo, en los casos que sea necesario aplicar el cumplimiento de términos y condiciones descritos en los documentos de confidencialidad o legalidad que señalen el ente que los ha incumplido, este debe someterse a una penalidad de daños y perjuicios que supone importes económicos, los cuales dependen de cada caso, con respecto al contrato inicial.
          h4.p-3 Duración
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-around.align-items-center
      ...
      .col-6
        .cajon
          p Podrían presentarse casos en los que la información siga siendo relevante y perjudicial para la empresa responsable en caso de ser divulgada, pues el plazo de los acuerdos para mantener la información privada puede ser menor o mayor, según el contrato. Sin embargo, en cualquier caso, es necesario que se amplíen los plazos en los acuerdos confidenciales para mantener seguros los recursos que continúen siendo valiosos para la firma. Otra forma de proteger el contenido es crear varios acuerdos con fechas diferentes y, dependiendo el valor del contenido a publicar, aunque resulte posible que la información sea ambigua o no represente un perjuicio publicarla, debe establecerse una parte de los acuerdos bajo los cuales aún tenga cierto grado de importancia e impida liberarla.
  
      .col-5
        .tarjeta.tarjeta--blanca(data-aos="zoom-in")
          img(src="@/assets/curso/portada/imagen4-legislacion-nueva.png")
    separador
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5(data-aos="zoom-in")
    ...
    .row.justify-content-around.align-items-center
      ...
      .bloque-texto-g.bloque-texto-color-verde-claro.p-3.p-sm-4.p-md-5
        .bloque-texto-g__img.imagen-texto-destacado(
          :style="{'background-image': `url(${require('@/assets/curso/portada/imagen-tipos-nueva.png')})`}"
        )
        .bloque-texto-g__texto.bloque-texto-color-azul.p-4
