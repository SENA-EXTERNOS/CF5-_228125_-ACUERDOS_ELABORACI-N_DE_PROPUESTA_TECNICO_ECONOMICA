...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-around.align-items-center
      ...
      .col-6
        .cajon.bloque-texto-color
          span Podrían darse casos en los que la información siga siendo relevante y perjudicial para la empresa responsable en caso de ser divulgada, pues el plazo de los acuerdos para mantener la información privada puede ser menor o mayor según el contrato.
