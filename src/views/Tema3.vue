...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-around.align-items-center
      ...
      .col-6
        .cajon
          p Podrían darse casos en los que la información siga siendo relevante y perjudicial para la empresa responsable en caso de ser divulgada, pues el plazo de los acuerdos para mantener la información privada puede ser menor o mayor según el contrato. Sin embargo, en cualquier caso, es necesario que se amplíen los plazos en los acuerdos confidenciales para mantener seguro los recursos que continúen siendo valioso para la firma. Otra forma de proteger el contenido es crear varios acuerdos con fechas distintas y, dependiendo el valor del contenido a publicar, aunque resulte posible que la información sea ambigua o no represente un perjuicio publicarla, debe establecerse una parte de los acuerdos bajo los cuales aún tenga cierto grado de importancia e impida liberarla.
